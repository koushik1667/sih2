                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 px-2.5 py-1 rounded-full bg-[#5D7052]/10 hover:bg-[#5D7052] text-[#5D7052] hover:text-[#F3F4F1] border border-[#5D7052]/30 text-[10px] font-bold transition"
                      title="Dispatch real-time FCM HTTP v1 push alert to registered devices"
                    >
