    ...
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#5D7052] hover:bg-[#4D5E44] text-[#F3F4F1] font-bold text-xs shadow-soft transition-all self-start hover:scale-105 active:scale-95"
        >
        ...
        <form onSubmit={handleSubmit} className="p-8 rounded-[2.5rem] bg-[#FEFEFA] border border-[#5D7052]/40 shadow-float space-y-5">
          ...
          <div className="pt-3 flex justify-end gap-3">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="px-6 py-2.5 rounded-full bg-[#5D7052] hover:bg-[#4D5E44] text-[#F3F4F1] font-bold text-xs shadow-soft transition hover:scale-102"
            >
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <button
                  ...
                  className="p-2.5 rounded-full text-[#78786C] hover:text-[#A85448] hover:bg-[#F0EBE5] transition"
                  title="Remove Farm"
                >
              ...
              <div className="flex items-center justify-between pt-3 border-t border-[#DED8CF]/60 text-xs text-[#78786C] font-medium">
                ...
                <button
                  ...
                  className="text-[#5D7052] font-bold hover:underline flex items-center gap-1"
                >
